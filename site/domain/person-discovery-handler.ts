...
async function history(database: D1Database, workspaceId: string, subject: string, secret: string, prospectId: string, now = Date.now()) {
  ...
  const [runs, decisions, relevance] = await Promise.all([
...
function emptyHistory() { return Object.freeze({ runs: Object.freeze([]), decisions: Object.freeze([]), relevance: Object.freeze([]), staleTrustedObservations: Object.freeze([]) }); }
