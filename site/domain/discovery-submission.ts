...
import { LOCAL_SYNTHETIC_RELEASE_EVIDENCE } from "./release-evidence";

export const PRIVATE_SYNTHETIC_PROOF_REVIEWED_SOURCE_REVISION = LOCAL_SYNTHETIC_RELEASE_EVIDENCE.sourceRevision;
export const PRIVATE_SYNTHETIC_PROOF_MIGRATION_IDENTITY = LOCAL_SYNTHETIC_RELEASE_EVIDENCE.migrationIdentity;
export const PRIVATE_SYNTHETIC_PROOF_MIGRATION_DIGEST = LOCAL_SYNTHETIC_RELEASE_EVIDENCE.migrationDigest;
export const PRIVATE_SYNTHETIC_PROOF_FIXTURE_PROVENANCE = LOCAL_SYNTHETIC_RELEASE_EVIDENCE.fixtureProvenance;
export const PRIVATE_SYNTHETIC_PROOF_FIXTURE_DIGEST = LOCAL_SYNTHETIC_RELEASE_EVIDENCE.fixtureDigest;
