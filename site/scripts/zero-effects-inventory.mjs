...
export const CANONICAL_EFFECT_TABLES = Object.freeze([
  ...
  "prospect_reentry_events", "prospect_review_decisions", "prospect_transition_events", "prospecting_candidates", "prospecting_run_events",
...
export const CANONICAL_TRIGGERS = Object.freeze([
  ...
  "prospect_review_immutable_delete", "prospect_review_immutable_update", "prospect_transition_continuity_insert",
  "prospect_transition_immutable_delete", "prospect_transition_immutable_update", "prospect_transition_scope_insert",
  "prospecting_fact_immutable_delete",
