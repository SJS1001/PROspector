...
function validEvidence() {
  return {
    ...
    local: {
      ...
      fixture: { digest: FIXTURE_DIGEST, provenance: "fixed-local-synthetic-fixture-v1" },
    },
...
test("fails closed for absent, expired, mismatched, replayed, stale, and unknown evidence", () => {
  const cases = [
    ...
    [Object.assign(validEvidence(), { authorization: { ...validEvidence().authorization, fixtureDigest: "d".repeat(64) } }), "fixture_digest_mismatch"],
    [Object.assign(validEvidence(), { authorization: { ...validEvidence().authorization, fixtureProvenance: "other-fixture-v1" } }), "fixture_provenance_mismatch"],
