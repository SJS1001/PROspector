...
test("D-07 proposal rendering is capped, escaped, evidence-rich, and Draft-only", async () => {
  ...
  try {
    ...
    assert.match(exploredHtml, /href="\/\?view=company-products&amp;interviewSessionId=0198b5c0-0000-7000-8000-000000002002&amp;marketPlayId=0198b5c0-0000-7000-8000-000000002003&amp;sourceProposalVersionId=0198b5c0-0000-7000-8000-000000000101"/);
