...
test("the runtime CLI prepares one private Access-mode candidate without secret values", async () => {
  ...
  const access = {
    ...
    releaseMigrationDigest: "6e6f086fb4b3e72c56d19594d3111cce39d95086c07ac58789c566fc0d867a4a",
    releaseMigrationIdentity: "canonical-chain-0020-private-synthetic-proof-migration-identity",
