...
async function setup(){
  ...
  ]); return {fixture,workspaceId:workspace.id,profileId:profile.id,runId:activation.initialRun.id,configurationId:activation.configuration.id,configurationDigest:activation.configuration.digest};
}
