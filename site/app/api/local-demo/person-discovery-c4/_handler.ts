...
import { validateSameOriginMutation } from "../../../../domain/request-security";

export async function handleLocalDemoSeed(request: Request) {
  ...
  if (validateSameOriginMutation(request, "person-discovery-c4-seed", 0))
