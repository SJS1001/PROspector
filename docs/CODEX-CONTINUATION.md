...
they grant neither invocation, persistence, nor cancellation authority, and
none executes a Phase 6 plan. A next safe unit may model pure synthetic
delivery-unknown/manual-reconciliation classification, but must remain
provider-free, outside runtime composition, incapable of retry or persistence,
and literal zero-effect. Do not access the original target or provision a new
