...
- A read-only resolution check on 2026-08-27 returned `project not found` for the exact original Sites project in the current account. Treat this account as local-work only. No substitute project was discovered or created and no hosted state changed.
