...
is also complete and still grants no invocation authority; none executes a
Phase 6 plan. A next safe unit may model pure originated-event/stop-rule
classification and cancellation decisions, but must remain synthetic,
provider-free, outside runtime composition, and literal zero-effect. Do not
