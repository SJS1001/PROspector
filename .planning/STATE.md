...
status: active
stopped_at: Phase 6 synthetic unsubscribe/explicit-opt-out suppression-before-success ordering verified; Plan 02-99 remains deferred; no persistence, cancellation, response, provider authority, or effect composed
last_updated: "2026-08-28T13:35:23Z"
...
Stopped at: Phase 6 synthetic unsubscribe/explicit-opt-out suppression-before-success ordering verified; target/provider adapters remain deferred; no hosted write, persistence/cancellation/response/provider authority, or external effect; draft PR `#2` remains open
